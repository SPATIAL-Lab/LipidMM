...
Afr.GR.conc.vcov <- var(data.frame(log(GR$c.n.C29), log(GR$c.n.C31), log(GR$c.n.C33)), use = "complete.obs")

Afr.SV.conc.mean.est <- c(mean(log(SV$c.n.C29), na.rm = T),
                        mean(log(SV$c.n.C31), na.rm = T), mean(log(SV$c.n.C33), na.rm = T))
Afr.SV.conc.vcov <- var(data.frame(log(SV$c.n.C29), log(SV$c.n.C31), log(SV$c.n.C33)), use = "complete.obs")

Afr.RF.conc.mean.est <- c(mean(log(RF$c.n.C29), na.rm = T),
                        mean(log(RF$c.n.C31), na.rm = T), mean(log(RF$c.n.C33), na.rm = T))
Afr.RF.conc.vcov <- var(data.frame(log(RF$c.n.C29), log(RF$c.n.C31), log(RF$c.n.C33)), use = "complete.obs")
...
rhum.l.GR.map <- map_estimate(rhum.l.mix$BUGSoutput$sims.list$FLMC[,1], method = "KernSmooth")
rhum.l.GR.median <- median(rhum.l.mix$BUGSoutput$sims.list$FLMC[,1])
rhum.l.GR.hdi <- hdi(rhum.l.mix$BUGSoutput$sims.list$FLMC[,1], ci = .89)

rhum.l.SV.map <- map_estimate(rhum.l.mix$BUGSoutput$sims.list$FLMC[,2], method = "KernSmooth")
rhum.l.SV.median <- median(rhum.l.mix$BUGSoutput$sims.list$FLMC[,2])
rhum.l.SV.hdi <- hdi(rhum.l.mix$BUGSoutput$sims.list$FLMC[,2], ci = .89)

rhum.l.RF.map <- map_estimate(rhum.l.mix$BUGSoutput$sims.list$FLMC[,3], method = "KernSmooth")
rhum.l.RF.median <- median(rhum.l.mix$BUGSoutput$sims.list$FLMC[,3])
rhum.l.RF.hdi <- hdi(rhum.l.mix$BUGSoutput$sims.list$FLMC[,3], ci = .89)

asso.l.GR.map <- map_estimate(asso.l.mix$BUGSoutput$sims.list$FLMC[,1], method = "KernSmooth")
asso.l.GR.median <- median(asso.l.mix$BUGSoutput$sims.list$FLMC[,1])
asso.l.GR.hdi <- hdi(asso.l.mix$BUGSoutput$sims.list$FLMC[,1], ci = .89)

asso.l.SV.map <- map_estimate(asso.l.mix$BUGSoutput$sims.list$FLMC[,2], method = "KernSmooth")
asso.l.SV.median <- median(asso.l.mix$BUGSoutput$sims.list$FLMC[,2])
asso.l.SV.hdi <- hdi(asso.l.mix$BUGSoutput$sims.list$FLMC[,2], ci = .89)

asso.l.RF.map <- map_estimate(asso.l.mix$BUGSoutput$sims.list$FLMC[,3], method = "KernSmooth")
asso.l.RF.media <- median(asso.l.mix$BUGSoutput$sims.list$FLMC[,3])
asso.l.RF.hdi <- hdi(asso.l.mix$BUGSoutput$sims.list$FLMC[,3], ci = .89)

baro.l.GR.map <- map_estimate(baro.l.mix$BUGSoutput$sims.list$FLMC[,1], method = "KernSmooth")
baro.l.GR.median <- median(baro.l.mix$BUGSoutput$sims.list$FLMC[,1])
baro.l.GR.hdi <- hdi(baro.l.mix$BUGSoutput$sims.list$FLMC[,1], ci = .89)

baro.l.SV.map <- map_estimate(baro.l.mix$BUGSoutput$sims.list$FLMC[,2], method = "KernSmooth")
baro.l.SV.median <- median(baro.l.mix$BUGSoutput$sims.list$FLMC[,2])
baro.l.SV.hdi <- hdi(baro.l.mix$BUGSoutput$sims.list$FLMC[,2], ci = .89)

baro.l.RF.map <- map_estimate(baro.l.mix$BUGSoutput$sims.list$FLMC[,3], method = "KernSmooth")
baro.l.RF.median <- median(baro.l.mix$BUGSoutput$sims.list$FLMC[,3])
baro.l.RF.hdi <- hdi(baro.l.mix$BUGSoutput$sims.list$FLMC[,3], ci = .89)
...
###compile parameters
#concentration
W.GR.conc.mean.est <- c(mean(log(W.GR$c.n.C29), na.rm = T),
                      mean(log(W.GR$c.n.C31), na.rm = T), mean(log(W.GR$c.n.C33), na.rm = T))
W.GR.conc.vcov <- var(data.frame(log(W.GR$c.n.C29), log(W.GR$c.n.C31),
                               log(W.GR$c.n.C33)), use = "complete.obs")

W.SV.conc.mean.est <- c(mean(log(W.SV$c.n.C29),na.rm = T),
                      mean(log(W.SV$c.n.C31),na.rm = T), mean(log(W.SV$c.n.C33), na.rm = T))
W.SV.conc.vcov <- var(data.frame(log(W.SV$c.n.C29), log(W.SV$c.n.C31),
                               log(W.SV$c.n.C33)), use = "complete.obs")

W.RF.conc.mean.est <- c(mean(log(W.RF$c.n.C29), na.rm = T),
                      mean(log(W.RF$c.n.C31), na.rm = T), mean(log(W.RF$c.n.C33), na.rm = T))
W.RF.conc.vcov <- var(data.frame(log(W.RF$c.n.C29), log(W.RF$c.n.C31),
                               log(W.RF$c.n.C33)), use = "complete.obs")

W.conc.vcov <- rbind(W.GR.conc.vcov, W.SV.conc.vcov, W.RF.conc.vcov)

W.conc.mu <- rbind(W.GR.conc.mean.est, W.SV.conc.mean.est, W.RF.conc.mean.est)
...
dat = list(d13C.mu.est = W.d13C.mu, d13C.omega.est = W.d13C.vcov,
           conc.mu.est = W.conc.mu, conc.omega.est = W.conc.vcov,  
           I = I, N = N, K = K, 
           RA.mix = RA.rhum.l, d13C.mix = d13C.rhum.l, d13C.mea.sd = d13C.sd.rhum.l)
